...
const SinglePromotionPage: React.FC = () => {
  ...
  const promotion = {
    ...
    description: "Get 20% off on all summer products until the end of the month.",
    longDescription: "Take advantage of our amazing summer sale with discounts on all seasonal items. Perfect for your outdoor activities, beach trips, and summer parties. This limited-time offer brings you the best quality products at unbeatable prices.",
  ...
  return (
    <div className="min-h-screen mt-20 bg-gradient-to-br from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
              ...
              >
                <h1 className="text-3xl sm:text-4xl font-bold text-white">{promotion.title}</h1>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="p-6 sm:p-8">
            ...
            >
              ...
              <p className="mt-4 text-gray-600">{promotion.longDescription}</p>
            </motion.div>
