        ...
        {!showCertificateDetails ? (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
              <h1 className="text-2xl font-bold text-center md:text-left mb-4 md:mb-0">Issued Certificate</h1>
          ...
          <div className="bg-white border-2 border-blue-400 rounded-lg shadow p-6">
            ...
            <div className="flex justify-between mb-6">
              ...
              <button className="border px-3 py-2 rounded-md text-gray-600 text-sm">View Certificate</button>
            </div>
